...
REM
REM Generated by Vivado on Mon Jun 08 22:17:19 +0800 2026
...
echo "xvlog --incr --relax -prj full_system_verify_tb_vlog.prj"
call xvlog  --incr --relax -prj full_system_verify_tb_vlog.prj -log xvlog.log

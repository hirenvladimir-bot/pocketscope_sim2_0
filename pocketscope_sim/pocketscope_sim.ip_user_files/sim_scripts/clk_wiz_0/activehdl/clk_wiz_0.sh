...
#
# Script generated by Vivado on Fri Jun 05 23:42:35 +0800 2026
...
map_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="D:/pocketscope_sim/pocketscope_sim/pocketscope_sim.cache/compile_simlib/activehdl"
  fi
  if [[ ($lib_map_path != "") ]]; then
